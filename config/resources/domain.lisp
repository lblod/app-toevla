...
(define-resource point-of-interest (scorable)
  ...
  :properties `((:label :string ,(s-prefix "rdfs:label"))
                ...
                (:has-online-ordering-and-payment-option :boolean ,(s-prefix "toevla:hasOrderingAndPaymentOnline"))
  ...
  :has-one `((route-description :via ,(s-prefix "toevla:hasPublicTransportRouteDescription")
             ...
             (concept :via ,(s-prefix "toevla:acceptanceOfMuseumPass")
                      :as "acceptance-of-museum-pass")
             (concept :via ,(s-prefix "toevla:acceptanceOfUitpas")
                      :as "acceptance-of-uitpas")
             (concept :via ,(s-prefix "toevla:acceptanceOfCityPass")
                      :as "acceptance-of-city-pass")
             (concept :via ,(s-prefix "toevla:acceptanceOfEdc")
                      :as "acceptance-of-edc")
             (concept :via ,(s-prefix "toevla:discountForGuide")
                      :as "discount-for-guide")
             (concept :via ,(s-prefix "toevla:discountForTranslator")
                      :as "discount-for-translator")
             (concept :via ,(s-prefix "toevla:wheelchairAvailability")
                      :as "wheelchair-availability"))
  :features '(include-uri)
  :resource-base (s-url "http://data.toegankelijk.vlaanderen.be/id/points-of-interest/")
  :on-path "points-of-interest")

(define-resource museum (point-of-interest)
  :class (s-prefix "toevla:Museum")
  :resource-base (s-url "http://data.toegankelijk.vlaanderen.be/id/musea/")
  :on-path "musea")

(define-resource restaurant (point-of-interest)
  ...
  :properties `((:comment :string ,(s-prefix "toevla:comment"))
                ...
                (:has-take-away-service :boolean ,(s-prefix "toevla:hasTakeAwayService"))
                (:has-home-delivery :boolean ,(s-prefix "toevla:hasHomeDelivery"))
                (:only-self-service :boolean ,(s-prefix "toevla:onlySelfService"))
                (:has-microwave-available :boolean ,(s-prefix "toevla:hasMicrowaveAvailable"))
                (:has-kid-play-corner :boolean ,(s-prefix "toevla:hasKidPlayCorner"))
                (:everything-on-ground-floor-or-with-plateau-elevator :boolean ,(s-prefix "toevla:everythingOnGroundFloorOrWithPlateauElevator"))
                (:has-wheelchair-friendly-table :boolean ,(s-prefix "toevla:hasWheelchairFriendlyTable"))
                (:height-under-table-for-wheelchair-in-consumption-space :number ,(s-prefix "toevla:heightUnderTableForWheelchairInConsumptionSpaceInCm"))
                (:only-has-high-tables :boolean ,(s-prefix "toevla:onlyHasHighTables"))
                (:has-table-square-with-supports-on-corners :boolean ,(s-prefix "toevla:hasTableSquareWithSupportsOnCorners"))
                (:has-table-square-with-central-support :boolean ,(s-prefix "toevla:hasTableSquareWithCentralSupport"))
                (:has-table-round-with-central-support :boolean ,(s-prefix "toevla:hasTableRoundWithCentralSupport"))
                (:comment-on-consumption-space :string ,(s-prefix "toevla:commentOnConsumptionSpace"))
                (:has-covered-terrace :boolean ,(s-prefix "toevla:hasCoveredTerrace"))
                (:terrace-accessible-from-outside :boolean ,(s-prefix "toevla:terraceAccessibleFromOutside"))
                (:tarrace-accessible-through-consumption-space :boolean ,(s-prefix "toevla:tarraceAccessibleThroughConsumptionSpace"))
                (:no-tarrace-available :boolean ,(s-prefix "toevla:noTarraceAvailable"))
                (:only-has-high-tables-on-terrace :boolean ,(s-prefix "toevla:onlyHasHighTablesOnTerrace"))
                (:has-table-square-with-supports-on-corners-on-terrace :boolean ,(s-prefix "toevla:hasTableSquareWithSupportsOnCornersOnTerrace"))
                (:has-table-square-with-central-support-on-terrace :boolean ,(s-prefix "toevla:hasTableSquareWithCentralSupportOnTerrace"))
                (:has-table-round-with-central-support-on-terrace :boolean ,(s-prefix "toevla:hasTableRoundWithCentralSupportOnTerrace"))
                (:height-under-table-for-wheelchair-on-terrace :boolean ,(s-prefix "toevla:heightUnderTableForWheelchairOnTerrace"))
                (:has-wheelchair-friendly-table-on-terrace :boolean ,(s-prefix "toevla:hasWheelchairFriendlyTableOnTerrace"))
                (:comment-on-terrace :string ,(s-prefix "toevla:commentOnTerrace"))
                (:has-conference-room :boolean ,(s-prefix "toevla:hasConferenceRoom"))
                (:has-playground :boolean ,(s-prefix "toevla:hasPlayground"))
                (:has-ballroom :boolean ,(s-prefix "toevla:hasBallroom"))
                (:comment-on-extra-facilities :string ,(s-prefix "toevla:commentOnExtraFacilities")))
  :has-one `((concept :via ,(s-prefix "toevla:reservationOptions")
                      :as "reservation-options")
             (area :via ,(s-prefix "toevla:sizeOfElevator")
                   :as "size-of-elevator")
...
(define-resource toilet ()
  ...
  :has-one `((area :via ,(s-prefix "toevla:sizeOfElevator")
             ...
             (concept :via ,(s-prefix "toevla:washbasinAvailability")
                      :as "washbasin-availability"))
...
(define-resource parking ()
  ...
  :properties `((:comment :string ,(s-prefix "toevla:comment"))
                ...
                (:description-of-parking-on-public-domain :string ,(s-prefix "toevla:descriptionOfParkingOnPublicDomain"))
...
(define-resource experience (scorable)
  ...
  :properties `((:title :string ,(s-prefix "dct:title"))
                ...
                (:audio-guide-available-via-headset :boolean ,(s-prefix "toevla:audioGuideAvailableViaHeatset"))
                (:audio-guide-available-via-smartphone :boolean ,(s-prefix "toevla:audioGuideAvailableViaSmartphone"))
                (:audio-guide-available-via-other-means :boolean ,(s-prefix "toevla:audioGuideAvailableViaOtherMeans"))
...
(define-resource guided-tour ()
  ...
  :properties `()
  :has-one `((concept :via ,(s-prefix "toevla:supportForVisualHandicap")
                      :as "support-for-visual-handicap")
             (concept :via ,(s-prefix "toevla:supportForAuditiveHandicap")
                      :as "support-for-auditive-handicap")
             (concept :via ,(s-prefix "toevla:supportForDeaf")
                      :as "support-for-deaf")
             (concept :via ,(s-prefix "toevla:supportForMentalHandicap")
                      :as "support-for-mental-handicap")
             (concept :via ,(s-prefix "toevla:supportForDementia")
                      :as "support-for-dementia")
             (concept :via ,(s-prefix "toevla:supportForAutism")
