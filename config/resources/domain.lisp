...
(define-resource restaurant ()
  ...
  :properties `((:has-cash-payment :boolean ,(s-prefix "toevla:hasCashPayment"))
                ...
                (:has-payment-with-movable-elecntronic-payment-system :boolean ,(s-prefix "toevla:hasPaymentWithMovableElecntronicPaymentSystem"))
                (:has-payment-with-fixed-elecntronic-payment-system :boolean ,(s-prefix "toevla:hasPaymentWithFixedElecntronicPaymentSystem"))
